 ...
 *
 * The client renders against a server-skew-adjusted clock (see DataProvider), so
 * all timestamps here live on the server timeline. Shared verbatim with the web app.
 */
